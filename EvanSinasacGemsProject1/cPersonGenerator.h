...
#include "cBabyNames.h"
#include "cStreetNames.h"
#include "cSurnames.h"
...
private:
	...
	unsigned int numOfSurnames;
	unsigned int numOfStreets;

	cSmartArray_Template<cBabyNames> saBabyNames;
	cSmartArray_Template<cSurnames> saSurnames;
	cSmartArray_Template<cStreetNames> saStreetNames;
};
